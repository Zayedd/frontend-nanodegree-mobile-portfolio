...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var allRanomPizzas = document.getElementsByClassName("randomPizzaContainer");
    var dx = determineDx(allRanomPizzas[0], size);
    var newwidth = (allRanomPizzas[0].offsetWidth + dx) + 'px';
    for (var i = 0; i < allRanomPizzas.length; i++) {
      allRanomPizzas[i].style.width = newwidth;
    }
  }
...
document.addEventListener('DOMContentLoaded', function() {
  var s = 256;
  var cols = window.screen.width / s;
